...
const Store = () => {
    return (
        <div className='p-8 md:px-72 md:py-16 bg-slate-200 flex'>
            ...
            <div className='px-8 md:px-24'>
                <img src={Play} alt="" className='max-w-[200px] md:max-w-[350px]'/>
                <img src={AppStore} alt="" className='max-w-[200px] md:max-w-[350px]'/>
            </div>
        </div>
    );
};
